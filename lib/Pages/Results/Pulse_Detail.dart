...
class _PulseDetailState extends State<PulseDetail> {
  ...
  getDate() async {
    ...
    if (_pulseResult == null) {
      ...
      if (mounted) {
        setState(() {
          pulseResult = _pulseResult['visitInfo']['parts'];
        });
      }
    }
  }
...
// =======================
                              RichText(
                                  text: TextSpan(children: [
                                    ...
                                    TextSpan(
                                        text:
                                            ' $guanresultPulsepeakpopulardesc',
                                        style: TextStyle(
                                            color: Colors.black, fontSize: 14))
                                  ]),
                                  softWrap: true),
...
// =======================
                              RichText(
                                  text: TextSpan(children: [
                                    ...
                                    TextSpan(
                                        text:
                                            ' $guanresultPulsefreqpopulardesc',
                                        style: TextStyle(
                                            color: Colors.black, fontSize: 14))
                                  ]),
                                  softWrap: true),
